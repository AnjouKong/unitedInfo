    ...
    $.fn.extend({
        ...
        timeGMT: function( options )
        {
            ...
            return this.each(function()
            {
                ...
                Date.prototype.getTimezoneByOffset = function( offset, y, m, d, time )
                {
                ...
                {
                    var date = this.getTimezoneByOffset(offset, null, null, null, options.time);
                ...
                {
                    var D = "星期日,星期一,星期二,星期三,星期四,星期五,星期六".split(","),
                ...
                var dateCheck = new Date().getTimezoneByOffset( offset, null, null, null, options.time );
                ...
                var current_time = options.time;
                // clock interval
                setInterval(function ()
                {
                    // create new date object
                    current_time = current_time + 1000;
                    var nd = new Date().getTimezoneByOffset( offset, null, null, null, current_time );
