...
;(function(root, factory){
	...
	Cursor.prototype.focus = function(){
		...
		if(this.wrap === 'body'){
			$f.focus();
			this.$cursor.css({
				width: parseInt($f.css('width')) + 10 + 'px',
				height: parseInt($f.css('height')) + 10 + 'px',
				left: parseInt($f.offset().left) - 5 + 'px',
				top: parseInt($f.offset().top) - 5 + 'px'
			}).show();
		}else{
			document.activeElement.blur();
			this.$cursor.css({
				left: parseInt($f.position().left) - 5 + 'px',
				top: parseInt($f.position().top) - 5 + 'px',
				width: parseInt($f.css('width')) + 10 + 'px',
				height: parseInt($f.css('height')) + 10 + 'px'
			}).show();
		}
